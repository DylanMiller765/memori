...
- A `AGENTS.md`, `AGENTS.md`, or similar project configuration file that defines voice and/or tone
...
5. **Capture it.** Suggest the user write the voice definition somewhere durable — a
   `AGENTS.md`, a design doc, a style guide — so it persists across sessions and
